...
**عدم اتصال:** اگه حس کردید کانکت نمیشه یا خطا میده دستور `rm -rf .cache/warp-plus` رو بزنید تا کش‌ها پاک بشن سپس دوباره دستور warp رو اجرا کنید.  
...
`socks://Og==@127.0.0.1:8086#WARP-TERMUX` 
