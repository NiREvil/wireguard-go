...
رو بزنید تا کش ها پاک بشن مجدد warp رو اجرا کنید.  
...
و یا برای تبدیل شدن وارپ به وارپ پلاس مستقیما از [ربات های تلگرام](https://t.me/F_NiREvil/5271) کلید لایسنس دریافت کرده و با دستور زیر  
...
برای زنجیر کردن (proxy chain) دو کانفیگ وارپ باهم و تغییر آی پی به غیر ایران از دستور  
...
**و اما بذار بهت بگم که** ببینید دستورات دیگه‌ای هم وجود دارن‌هاا
...
> اون US برای مثال بود می‌تونی هر لوکیشنی قرار بدی یه جای اون

خلاصه اینکه یا انتخاب ورژن آی‌پی رو بسپر به وارپ‌پلاس یا که خودت هندل کن.  

**ولـی ولــــــی** ممکنه انتخاب آی‌پی رو بسپاری دست خودش و بیاد حتی ipv4 که مورد نطرت هست رو انتخاب کنه ولی از یه رنج شخمی، فرضا برای مخابرات الان هیشکدوم از آی‌پی ها از رنج 162 کار نمیکنن، فقط 188 اوکیه

مثلا این آی‌پی‌ها با مخابرات خوبن: 
...
اینم با همراه اول خوب بودش `188.114.97.134:1180`


اگه تو نکوباکس، هیدیفای، ویتوری یا هرجایی کانفیگ وایرگاردی وجود داره که کارکرد اون برات عالیه آی‌پی و پورت همون رو حفظ کن بیا با دستور  

`warp -e IP:PORT` 

بده بهش تا ممبعد وقتی استارت کردی وارپ رو از همین آی‌پی و پورت ک تو پروفایلت ذخیره شده استفاده کنه.  

همچنین میشه از [اسکنر پیمان](https://t.me/F_NiREvil/6305) که دیروز دربارش حرف زدیم استفاده کرد برای اسکن آی‌پی وارپ و استفاده ازش تو این پروژه مود بحث.
